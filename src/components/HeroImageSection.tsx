    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          {eager && <link rel="preload" as="image" href={backgroundImage} />}
        ...
        {/* Content Container */}
        <div
          className={`relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col ${alignmentClasses[alignment]} max-w-4xl`}
        >
          {/* Animated Title */}
          <motion.h1
