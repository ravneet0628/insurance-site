...
export const aboutPageContent: AboutPageContent = {
  meta: {
    ...
    description: "Learn about SecureChoice Insurance's 20+ year journey providing comprehensive insurance solutions to Canadian families and businesses. Meet our expert team.",
    keywords: ["about SecureChoice", "insurance company", "Canadian insurance", "insurance experts", "company history"]
  },

  hero: {
    title: "About SecureChoice Insurance",
    subtitle: "Over two decades of experience protecting Canadian families and businesses with comprehensive insurance solutions and exceptional service.",
    ...
    items: [
      {
        ...
        description: "SecureChoice Insurance was established with a vision to provide personalized insurance solutions."
      },
      {
        year: "2008", 
        title: "Expanded Services",
        description: "Added life, disability, and critical illness insurance to our growing portfolio of services."
      },
      {
        year: "2012",
        title: "Digital Innovation",
        description: "Launched our online platform for faster quotes and streamlined customer service."
      },
      {
        year: "2016",
        title: "Investment Services",
        description: "Introduced RESP, RRSP, and TFSA investment services to help clients build wealth."
      },
      {
        year: "2020",
        title: "Enhanced Support",
        description: "Implemented 24/7 customer support and expanded our claims assistance services."
      },
      {
        year: "2024",
        title: "Continued Growth",
        description: "Serving over 50,000 customers across Canada with comprehensive insurance solutions."
      }
    ]
  },
  ...
  team: {
    ...
    subtitle: "Our experienced professionals are here to help you find the right insurance solutions.",
    members: [
      {
        name: "Sarah Johnson",
