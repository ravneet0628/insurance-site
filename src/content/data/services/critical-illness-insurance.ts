...
export const criticalIllnessInsuranceContent: ServiceContent = {
  meta: {
    ...
    description: 'Protect yourself against critical illnesses with comprehensive coverage. Lump sum payments for cancer, heart attack, stroke, and 25+ other conditions.',
    keywords: ['critical illness insurance', 'cancer coverage', 'heart attack insurance', 'stroke coverage', 'serious illness protection'],
  },
  hero: {
    title: 'Critical Illness Insurance',
    subtitle: 'Financial protection when you need it most. Get a lump sum payment to help cover expenses when diagnosed with a critical illness.',
  ...
  overview: {
    ...
    content: 'Critical Illness Insurance provides a tax-free lump sum payment upon diagnosis of a covered critical illness. This financial support helps you focus on recovery while covering medical expenses, lost income, and other costs not covered by traditional health insurance.',
    highlights: [
  ...
  details: {
    ...
    content: 'Critical Illness Insurance provides financial support when you need it most, with a straightforward claims process and flexible use of benefits.',
    items: [
      {
  ...
  cta: {
    ...
    subtitle: 'One in two people will be diagnosed with cancer in their lifetime. Don\'t face a critical illness without financial protection.',
