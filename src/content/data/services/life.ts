...
export const lifeInsuranceContent: ServiceContent = {
  meta: {
    ...
    description: "Protect your family's future with our comprehensive life insurance plans. Term, whole, and universal life options available.",
    keywords: ["life insurance", "term life", "whole life", "family protection", "death benefit"]
  },
  
  hero: {
    title: "Life Insurance",
    subtitle: "Protect your family's financial future with comprehensive life insurance coverage tailored to your needs.",
  ...
  overview: {
    ...
    content: "Life insurance provides essential financial protection for your loved ones when they need it most. Our comprehensive plans ensure your family can maintain their lifestyle, pay off debts, and secure their future even in your absence.",
    highlights: [
  ...
  features: {
    ...
    features: [
      ...
      },
      {
        ...
        description: "Permanent coverage with cash value accumulation and guaranteed premiums for lifetime protection.",
        details: [
  ...
  details: {
    ...
    content: "Our life insurance policies are designed to provide comprehensive financial protection with features that adapt to your changing needs throughout life.",
    items: [
      {
  ...
  cta: {
    ...
    subtitle: "Get a personalized life insurance quote in minutes and secure your family's financial future today.",
