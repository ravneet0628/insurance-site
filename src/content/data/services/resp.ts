...
export const respContent: ServiceContent = {
  meta: {
    ...
    description:
      "Save for your child's education with RESP. Get government grants up to $7,200, tax-deferred growth, and flexible investment options for post-secondary education.",
    keywords: [
      'RESP',
